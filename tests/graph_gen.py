...
title = "Augstas un zemasslodzes tests ar datubāzi - Lambda vs EC2"
...
for name, source in data_sources.items():
    ...
    mask = ~error_codes
    plt.plot(sorted_durations[mask], cumulative_prob[mask], 'o', markersize=2, color=source['color'], alpha=0.6, zorder=2)
